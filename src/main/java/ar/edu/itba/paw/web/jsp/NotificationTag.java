    ...
    private String print(Notification notification) {
        ...
        if (notification instanceof RetwattNotification) {
            ...
            result = new StringBuilder()
                        .append("<tr><td><div><img src=\"" + ((HttpServletRequest)pageContext.getRequest()).getContextPath() + "/bin/image/")
                        .append(fn.getFollower().getUsername())
                        .append("\"></div></td><td colspan=\"3\">El usuario <a href=\"" + ((HttpServletRequest)pageContext.getRequest()).getContextPath() + "/bin/user/profile/")
                        .append(fn.getFollower().getUsername())
                        .append("\">")
                        .append(fn.getFollower().getUsername())
